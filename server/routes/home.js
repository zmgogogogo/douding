...
router.get('/home/init', authOptional, (req, res) => {
  try {
    ...
    // 核心功能入口
    const mainTools = [
      { name: '图片转拼豆', icon: 'ImageIcon', bgColor: '#dcfce7', iconColor: '#16a34a', route: '/image-import' },
      { name: '空白创作', icon: 'PenIcon', bgColor: '#dbeafe', iconColor: '#2563eb', route: '/editor' },
      { name: 'Q版生成', icon: 'SparklesIcon', bgColor: '#fef3c7', iconColor: '#d97706', route: '/editor?mode=qstyle' },
      { name: '辅助拼豆', icon: 'Grid3X3Icon', bgColor: '#fce7f3', iconColor: '#db2777', route: '/editor?mode=assist' }
    ]
