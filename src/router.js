...
const routes = [
  ...
  { path: '/image-import', name: 'imageImport', component: () => import('./views/ImageImportView.vue') },
  ...
  { path: '/link-import', name: 'linkImport', component: () => import('./views/LinkImportView.vue') },
]
