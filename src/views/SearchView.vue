...
<template>
  <div class="overflow-y-auto h-full p-5">
    <div class="max-w-[400px] mx-auto mb-5 relative">
      <input v-model="query" type="text" placeholder="搜索公开图纸..."
        class="w-full h-[42px] border border-slate-200 rounded-full pl-5 pr-12 text-sm
    ...
    <div class="grid grid-cols-[repeat(auto-fill,minmax(200px,1fr))] gap-4 max-w-[1200px] mx-auto">
      <DesignCard v-for="d in results" :key="d.id" :design="d"
